// Utility: preload images (inlined from utils.js so this runs as a classic
// script and works over file:// as well as http — ES module imports are
// blocked by the browser over the file:// protocol).
...
const createScrollAnimation = (carousel) => {
  ...
  // Scroll-driven rotation (no pin): the ring rolls as the scene passes through
  // the viewport. How close consecutive groups sit — and the rotation speed —
  // is governed by the scene height in CSS (shorter = closer + a touch faster).
